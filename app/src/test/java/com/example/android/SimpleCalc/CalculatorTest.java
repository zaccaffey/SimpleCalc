...
public class CalculatorTest {
    ...
    public void addTwoNumbersNegative() {
        double resultAdd = mCalculator.add(-1, -2);
    ...
    public void subTwoNumbers() {
        double resultSub = mCalculator.sub(2, 1);
    ...
    public void mulTwoNumbersZero() {
        double resultMul = mCalculator.mul(0, 3);
        assertThat(resultMul, is(equalTo(0d)));
    }

    @Test
    public void divTwoNumbers() {
        double resultDiv = mCalculator.div(6, 2);
    ...
    public void divByZeroThrows() {
        ...
        //Log.d("This is the Result Div", String.valueOf(resultDiv));
    ...
    @Test
    public void powNegativeIntFirst() {
        double resultPow = mCalculator.pow(-3,2);
        assertThat(resultPow, is(equalTo(9d)));
    }

    @Test
    public void powNegativeIntSecond() {
        double resultPow = mCalculator.pow(3,-2);
        assertEquals(0.1111, resultPow, .001);
        //assertThat(resultPow, is(equalTo(0.111)));
    }

    @Test
    public void zeroFirstAndPosSecond() {
        double resultPow = mCalculator.pow(0, 3);
        assertThat(resultPow, is(equalTo(0d)));
    }

    @Test
    public void zeroAsSecond() {
        double resultPow = mCalculator.pow(3, 0);
        assertThat(resultPow, is(equalTo(1d)));
    }

    @Test
    public void zeroAsFirstNegOneAsSecond() {
        double resultPow = mCalculator.pow(0, -1);
        assertThat(resultPow, is(equalTo(Double.POSITIVE_INFINITY)));
    }

    @Test
    public void negZeroAsFirst() {
        double resultPow = mCalculator.pow(-0, -1);
        assertThat(resultPow, is(equalTo(Double.POSITIVE_INFINITY)));
    }
